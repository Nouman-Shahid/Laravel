...
@section('content')
    ...
    <div class="flex flex-col w-[82vw] bg-slate-100 h-screen justify-start items-center mt-5">
        ...
        <div class="isolate bg-gray-50 px-6 py-2 sm:py-4 lg:px-[20vh] ">
            ...
            <form action="{{ route('addflight') }}" method="POST" class="mx-auto mt-4 max-w-xl sm:mt-10">
                ...
                <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        <label for="email"
                            class="block text-sm font-semibold leading-6 text-gray-900">Destination</label>
                        <div class="mt-2.5">
