            ...
            <div class="flex flex-col items-center w-full  pr-10 pb-20 pl-10 lg:pt-4 lg:flex-row">
                ...
                <div class="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
                    <div
                        ...
                        <p class="w-full text-4xl font-medium text-center leading-snug font-serif">Admin Sign in</p>
                        <form class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8" action="{{ route('admin.signin') }}"
                            method="post">
                            @csrf
                            <div class="relative">
                                <p
                                ...
                                <input placeholder="123@ex.com" type="text" required name="email"
                                    class="border-2 placeholder-gray-400 @error('email') border-red-600 @enderror focus:outline-none focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white rounded-md" />
                            ...
                            <div class="relative">
                                ...
                                <input placeholder="Password" type="password" required name="password"
                                    class="border-2 @error('password') border-red-600 @enderror placeholder-gray-400 focus:outline-none focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white rounded-md" />
                                <span class="text-red-600">
                                    @error('password')
                                        {{ $message }}
                                    @enderror
